...
""")
    ...
    println(io, "    <ShuttleEdge idleCount=\"500\" steps=\"5\" startLength=\"0\" stopLength=\"0\" startLine=\"2\" startName=\"Center\" stopLine=\"$(ntest_lines + 3)\" stopName=\"Zeros\"/>")
