...
const coeff_data_nozx, electrode_names_nozx = matopen(joinpath(@__DIR__, "../data/compensate_nozx_20220927.mat")) do mat
    return read(mat, "data"), read(mat, "electrode_names")
end

const coeff_data_zx, electrode_names_zx = matopen(joinpath(@__DIR__, "../data/compensate_20220927.mat")) do mat
    return read(mat, "data"), read(mat, "electrode_names")
end
...
const prefix = joinpath(@__DIR__, "../data/transfer_smooth_20220927")
