...
const coeff_data, electrode_names = matopen(joinpath(@__DIR__, "../data/compensate_x2z_20220927.mat")) do mat
    return read(mat, "data"), read(mat, "electrode_names")
end

const outputdir = joinpath(@__DIR__, "../data/compensate_x2z_20220927")
