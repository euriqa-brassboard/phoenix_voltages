...
const solutions = [("local", load_solution("merge_20221118_local.mat")),
                   ("blk 70", load_solution("merge_20221118_blk70.mat"))
                   ]

const prefix = joinpath(@__DIR__, "../imgs/merge_20221118")
