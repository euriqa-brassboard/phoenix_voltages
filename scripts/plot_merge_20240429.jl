...
const solutions = [("local", load_solution("merge_20240429_local.mat")),
                   ("blk 70", load_solution("merge_20240429_blk70.mat"))
                   ]

const prefix = joinpath(@__DIR__, "../imgs/merge_20240429")
