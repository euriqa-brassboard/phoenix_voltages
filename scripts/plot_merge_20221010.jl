...
const solutions = [("local", load_solution("merge_20221010_local.mat")),
                   ("blk 100", load_solution("merge_20221010_blk100.mat"))]

const prefix = joinpath(@__DIR__, "../imgs/merge_20221010")
