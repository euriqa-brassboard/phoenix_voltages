...
const prefixes = ["compensate_20220808"=>("Origin", 10),
                  "compensate2_20220808"=>("With \$x^2z\$", 11),
                  "compensate_nozx_20220808"=>("No \$zx\$", 9)]
const prefix = joinpath(@__DIR__, "../imgs/compensate_20220808")
...
function load_solutions(prefix, num)
    it = (load_solution("$(prefix)_$(i).mat") for i in 1:num)
