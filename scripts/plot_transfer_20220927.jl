...
const solution_ind = load_solution("transfer_20220927.mat")
const solution_smooth = load_solution("transfer_smooth_20220927.mat")
const solution_smooth_noglobal = load_solution("transfer_smooth_20220927_noglobal.mat")

const prefix = joinpath(@__DIR__, "../imgs/transfer_20220927")
