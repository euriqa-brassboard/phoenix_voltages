...
const coeff_data, electrode_names = matopen(joinpath(@__DIR__, "../data/compensate_red2_20221213.mat")) do mat
    return read(mat, "data"), read(mat, "electrode_names")
end

const outputdir = joinpath(@__DIR__, "../data/compensate_red2_20221213")
