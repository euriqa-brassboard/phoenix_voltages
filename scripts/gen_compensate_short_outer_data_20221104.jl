...
const coeff_data, electrode_names = matopen(joinpath(@__DIR__, "../data/compensate_short_outer_20221104.mat")) do mat
    return read(mat, "data"), read(mat, "electrode_names")
end

const outputdir = joinpath(@__DIR__, "../data/compensate_short_outer_20221104")
