...
const prefixes = [
    "compensate_20220927"=>("origin", 10),
    "compensate_x2z_20220927"=>("x2z", 11),
    "compensate_nozx_20220927"=>("nozx", 9)
]
const prefix = joinpath(@__DIR__, "../imgs/compensate_20220927_diff2")

const potential_file = ARGS[1]
const potential = Potentials.import_pillbox_64(potential_file)
const fits_cache = Solutions.compensate_fitter1(potential, sizes=(5, 5, 130))
