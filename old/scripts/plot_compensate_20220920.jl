...
const prefixes = ["compensate_20220920"=>("Origin", 10),
                  "compensate_x2z_20220920"=>("With \$x^2z\$", 11),
                  "compensate_nozx_20220920"=>("No \$zx\$", 9)]
const prefix = joinpath(@__DIR__, "../imgs/compensate_20220920")
