...
const comp_terms1 = [Solutions.get_compensate_terms1(fit, solution.stride .* 1000) for fit in comp_fits1]
const comp_terms2 = [Solutions.get_compensate_terms1(fit, solution.stride .* 1000) for fit in comp_fits2]
